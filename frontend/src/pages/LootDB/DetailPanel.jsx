...
const STAT_LABELS = {
  ...
  hydrogen_flow_rate:    'Hydrogen Flow',
  quantum_flow_rate:     'Quantum Flow',
  max_integrity:         'Max Integrity',
  fuel_rate:             'Fuel Rate',
...
const STAT_GROUPS = {
  ...
  refueling: { label: 'Refueling', keys: new Set(['hydrogen_flow_rate', 'quantum_flow_rate', 'max_integrity']) },
