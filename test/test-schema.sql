...
, source TEXT NOT NULL DEFAULT 'pledge');
...
CREATE TABLE user_module_selection (
  ...
  created_at  TEXT    DEFAULT (datetime('now')),
  updated_at  TEXT    DEFAULT (datetime('now')), module_kind TEXT NOT NULL DEFAULT 'bay',
...
CREATE INDEX idx_user_fleet_tags_user_id ON user_fleet_tags(user_id);
CREATE INDEX idx_user_fleet_tags_fleet_id ON user_fleet_tags(user_fleet_id);
CREATE INDEX idx_changelog_published_date
...
CREATE INDEX idx_user_weapon_builds_user ON user_weapon_builds(user_id);
CREATE UNIQUE INDEX idx_user_weapon_builds_unique
...
CREATE UNIQUE INDEX idx_mining_location_deposits_natural_key
...
INSERT INTO game_versions VALUES(1,'11319298-4600-0000-0000-000000000001','4.6.0-live.11319298','LIVE',1,'2026-02-25','2026-07-17 17:23:10','2026-07-17 17:23:10','11319298');
INSERT INTO game_versions VALUES(2,'test-0000-0000-0000-000000000001','4.0.0-test','LIVE',1,'2026-01-01','2026-07-17 17:23:37','2026-07-17 17:23:37',NULL);
...
INSERT INTO manufacturers VALUES(1,'00000000-0000-0000-0000-000000000001','Generic','generic','GENERIC',NULL,'Unbranded / commodity gear with no specific consumer manufacturer in p4k. Assigned by the extractor when tag-, AttachDef-, filename-segment, and static-prefix lookups all return None.',NULL,NULL,1,'2026-07-17 17:23:30','2026-07-17 17:23:30',NULL,0,NULL,0,NULL,NULL);
INSERT INTO changelog_entries VALUES(1,NULL,'2026-06-06','Ship bomb stats on item pages','Ship-launched bombs now show their full damage and blast-radius stats on the item detail page.','feature',1,'2026-07-17 17:23:35');
INSERT INTO changelog_entries VALUES(2,NULL,'2026-06-05','Refuelling nozzle deep stats','Ship refuelling nozzles now display hydrogen/quantum flow rates and integrity on their detail pages.','feature',1,'2026-07-17 17:23:35');
INSERT INTO changelog_entries VALUES(3,NULL,'2026-06-05','Where to Buy + community price reporting','Loot items now show where to buy them, with community-reported prices you can contribute to and a freshness indicator.','feature',1,'2026-07-17 17:23:35');
INSERT INTO changelog_entries VALUES(4,NULL,'2026-06-05','Faction panel no longer clips long lists','The faction detail panel now scrolls correctly when a faction has a long list of blueprint rewards.','fix',1,'2026-07-17 17:23:35');
INSERT INTO changelog_entries VALUES(5,NULL,'2026-06-04','Component role/class labels in Localization','The Localization builder can now show a component''s role/class as an in-game label.','feature',1,'2026-07-17 17:23:35');
INSERT INTO changelog_entries VALUES(6,NULL,'2026-06-02','Rock Calculator: shareable configs + saved loadouts','Mining rock configurations are now captured in the URL for sharing, and you can save/reload ship loadouts.','improvement',1,'2026-07-17 17:23:35');
