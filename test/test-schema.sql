...
CREATE TABLE accountant_entries (
    ...
    notes           TEXT,
    created_at      TEXT DEFAULT (datetime('now'))
, order_id     INTEGER REFERENCES accountant_orders(id), workorder_id INTEGER REFERENCES accountant_workorders(id));
...
INSERT INTO game_versions VALUES(1,'11319298-4600-0000-0000-000000000001','4.6.0-live.11319298','LIVE',1,'2026-02-25','2026-06-12 22:09:12','2026-06-12 22:09:12','11319298');
INSERT INTO game_versions VALUES(2,'test-0000-0000-0000-000000000001','4.0.0-test','LIVE',1,'2026-01-01','2026-06-12 22:09:22','2026-06-12 22:09:22',NULL);
