...
CREATE TABLE accountant_entries (
    ...
    notes           TEXT,
    created_at      TEXT DEFAULT (datetime('now'))
, order_id     INTEGER REFERENCES accountant_orders(id), workorder_id INTEGER REFERENCES accountant_workorders(id), org_id TEXT REFERENCES organization(id));
CREATE TABLE accountant_tags (
    id         INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id    TEXT NOT NULL,
    category   TEXT NOT NULL,
    name       TEXT NOT NULL COLLATE NOCASE,
    created_at TEXT DEFAULT (datetime('now')), org_id TEXT REFERENCES organization(id),
...
CREATE TABLE accountant_orders (
    ...
    notes                 TEXT,
    created_at            TEXT DEFAULT (datetime('now'))
, publisher TEXT, org_id TEXT REFERENCES organization(id));
-- ── indexes ──
...
CREATE UNIQUE INDEX idx_accountant_entries_order_tick ON accountant_entries (order_id, tick_index)
    WHERE order_id IS NOT NULL AND tick_index IS NOT NULL;
...
INSERT INTO game_versions VALUES(1,'11319298-4600-0000-0000-000000000001','4.6.0-live.11319298','LIVE',1,'2026-02-25','2026-06-13 17:01:34','2026-06-13 17:01:34','11319298');
INSERT INTO game_versions VALUES(2,'test-0000-0000-0000-000000000001','4.0.0-test','LIVE',1,'2026-01-01','2026-06-13 17:01:49','2026-06-13 17:01:49',NULL);
